...
import com.badlogic.libgdx.canyonbunn.game.objects.AbstractGameObject;
			...
			for(int pixelX = 0; pixelX < pixmap.getWidth(); pixelX++)
			{
				...
				else if(BLOCK_TYPE.ROCK.sameColor(currentPixel))
				{
					if(lastPixel != currentPixel)
					{
						...
						offsetHeight = -2.5f;
						obj.position.set(pixelX, baseHeight * obj.dimension.y * heightIncraseFactor + offsetHeight);
						rocks.add((Rock)obj);
					}else
					{
